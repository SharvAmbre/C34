...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   s1 = createSprite(320,50,20,20)
   s2 = createSprite(50,370,20,20)
   balloon2 = createImg('baloon2.png')
   s1.addImage(star)
   s2.addImage(star)
   s1.scale = 0.02
   s2.scale = 0.02
  balloon2.position(260,370)
  balloon2.size(100,100)
  balloon2.mouseClicked(airblow)
...
function draw() 
{
  ...
  if(collide(fruit,s1,20)==true) {
    s1.visible = false
  }
  if(collide(fruit,s2,20)==true) {
    s2.visible = false
  }
